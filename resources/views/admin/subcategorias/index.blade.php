...
<x-slot name="action">
    <a class="btn btn-purple" href="{{ route('admin.subcategorias.create') }}">
        Nuevo
    </a>
</x-slot>
...
@if ($subcategorias->count())
                ...
                <tbody>
                    @foreach ($subcategorias as $subcategoria)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                {{ $subcategoria->categoria->familia->nombrefam }}
                            </td>
                            <td class="px-6 py-4">
    ...
    @else
        <div class="flex items-center p-4 text-sm text-purple-800 rounded-lg bg-purple-50 dark:bg-gray-800 dark:text-purple-400"
            ...
            <div>
                <span class="font-medium">Alerta!</span> Todavia no hay subcategorias para los productos
            </div>
        </div>
    @endif
</x-admin-layaout>