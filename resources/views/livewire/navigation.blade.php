                ...
                <div class="w-80 xl:w-[57rem] pt-[52px] hidden md:block ">
                    <div class="bg-white h-[calc(100vh-52px)] overflow-auto px-6 py-8">
                        ...
                        <div class="mb-8 flex justify-between items-center">
                            ...
                            <a href="{{ route('familias.show', $familia_id) }}" class="btn btn-purple">Ver todo</a>
                        </div>
                        <ul class="grid grid-cols-1 xl:grid-cols-3 gap-8">
                            @foreach ($this->categorias as $categoria)
                                <li>
                                    <a href="{{route('categorias.show', $categoria)}}" class="text-purple-600 font-semibold text-lg">
                                        {{ $categoria->nombrecat }}
                                    </a>
